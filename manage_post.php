...
<body>
   ...
   <header id="top">
   	...
   	<div class="row">
   		...
   		<div class="header-content twelve columns">
		      ...
		      <h1 id="logo-text"><a href="index.php" title="">Rubel Rana</a></h1>
   ...
   <div id="content-wrap">
     ...
     ?>
        ...
        <br>
        <p>"Life always offers you a secound chance. it's called tomorrow."</p>
   ...
   <footer>
      ...
      <div class="row"> 
         ...
         <p class="copyright"> Copyright&copy;All Rights Reserved 2019.Developed by Md.Rubel Rana. &nbsp;</p>
